...
- Popup: one row per service (no edition-row duplication), edition pills aligned right, official Veeam service names per [ADR-003](ADR-003-official-veeam-service-naming.md).
